package com.mac.asciiminesweeper.ascii;
...
public class AsciiPanel extends JPanel {
    ...
    public AsciiPanel(Dimension dimension, String tilesetFile, int characterWidth, int characterHeight, int scale) {
        ...
        try {
            ...
            InputStream in = AsciiPanel.class.getClassLoader().getResourceAsStream(tilesetFile);
            BufferedImage tilesets = ImageIO.read(in);
